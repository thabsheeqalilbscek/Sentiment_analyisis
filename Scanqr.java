...
//        startActivity(new Intent(Scan_qr.this,Student_details.class));
    ...
    public void scanQR() {
        try {
            ...
            showDialog(com.example.jamia_virtual_shopping.Scanqr.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
        }
    }
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        Intent i =new Intent(getApplicationContext(),Scanqr2.class);
                                        startActivity(i);
                                    } else {
                                        Toast.makeText(getApplicationContext(), "Fraud QR", Toast.LENGTH_LONG).show();
                                    }
...
//                        params.put("amount",sh.getString("amount",""));//passing to python
                        params.put("master",sh.getString("mid",""));//passing to python
                        params.put("id", sh.getString("lid",""));//passing to python
                        params.put("key", contents);//passing to python
