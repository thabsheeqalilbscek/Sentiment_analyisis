...
public class Upipay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upipay2);
...
//        upivirtualid.setText(sh.getString("pname",""));
//        upivirtualid.setEnabled(false);
//        amount.setText(sh.getString("amnt",""));
...
//		upiPayIntent.setData(uri);
    ...
    public static boolean isConnectionAvailable(Upipay context) {
