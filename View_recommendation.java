...
public class View_recommendation extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView li;
    ...
    public void load_recommendation(final String type){

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        ip = sh.getString("url", "");
        url = ip + "get_recommendation";
...
//                                    Toast.makeText(getApplicationContext(), "rr"+com[i], Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", type);//passing to python
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (pos){
                    case 0:
                        load_recommendation("review");
                        break;
                    case 1:
                        load_recommendation("colour");
                        break;
                }
            }
